...
export default function AboutPreview() {
  ...
  return (
    <section className="py-20 bg-brand-navy text-white" data-testid="about-preview">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-4xl font-bold mb-6" data-testid="about-preview-title">
            ...
            <div className="space-y-6 mb-8">
              {features.map((feature, index) => (
                <div key={index} className="flex items-start space-x-4" data-testid={`about-feature-${index}`}>
                  <div className="w-6 h-6 bg-brand-gold rounded-full flex items-center justify-center mt-1 flex-shrink-0">
            ...
            <Button 
              asChild
              size="lg"
              className="bg-brand-gold hover:bg-brand-light-gold text-brand-navy font-semibold shadow-xl"
          ...
          <div className="relative">
            ...
            <Card className="absolute -top-6 -left-6 shadow-xl" data-testid="iso-card">
              <CardContent className="p-6">
                <div className="text-center">
                  <div className="text-3xl font-bold text-brand-navy">ISO</div>
                  <div className="text-brand-gold font-semibold">9001:2015</div>
                  <div className="text-sm text-brand-gray">Certified Quality</div>
                </div>
              </CardContent>
            </Card>
            
            <Card className="absolute -bottom-6 -right-6 bg-brand-gold shadow-xl" data-testid="experience-card">
              <CardContent className="p-6">
                <div className="text-center">
                  <div className="text-3xl font-bold text-brand-navy">15+</div>
                  <div className="text-brand-navy font-semibold">Years</div>
                  <div className="text-sm text-brand-navy">Industry Experience</div>
                </div>
              </CardContent>
            </Card>
          </div>
